...
- Latest user direction: continue with utmost progress, use available tools/apps, keep doing stronger work, and remain inside the confirmed assigned repository only.
