...
- Latest user direction: continue with ambition, use available tools/apps, keep building achievements, and remain inside the confirmed assigned repository only.
...
1. Use `agency-ops/ops/90-day-agency-growth-flywheel.md`, `agency-ops/ops/agency-automation-control-loop.md`, and `agency-ops/ops/next-move-command-board.md` to select the next safe artifact.
